...
public class ReunionFormController {
    ...
    @FXML public void initialize() {
        ...
        btnGenerate.setOnAction(e -> formLink.setText(externalApiService.generateMeetingLink()));
        ...
        if (editing == null) {
            ...
            formIdRh.setText("1"); formDate.setValue(LocalDate.now().plusDays(1)); formLink.setText(externalApiService.generateMeetingLink());
        } else {
